...
urlpatterns = [
    ...
    path('users/<username_or_pk>/late_days/', views.DeprecatedUserLateDaysView.as_view(),
         name='deprecated-user-late-days'),
    ...
    path('courses/<int:course_pk>/late_day_usage_history/<username_or_pk>/',
         views.ListUserLateDayUsageHistoryView.as_view(),
         name='user-late-day-usage-history'),
    path('courses/<int:course_pk>/late_day_usage_history/',
         views.ListLateDayUsageHistoryView.as_view(),
         name='late-day-usage-history'),
    path('courses/<int:course_pk>/late_days/<username_or_pk>/', views.UserLateDaysView.as_view(),
         name='user-late-days'),
]
