...
class _DummyAutograderModelSerialier(AGModelSerializer):
    def get_ag_model_manager(self):
        return _DummyAutograderModel.objects


class AGModelSerializerTestCase(test.TestCase):
    def setUp(self):
    ...
    def test_serialize(self):
        serializer = _DummyAutograderModelSerialier(self.ag_model)
        self.assertEqual(self.ag_model.to_dict(), serializer.data)
