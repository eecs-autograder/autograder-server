# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-06-15 23:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(help_text='The Submission that this result is for.', on_delete=django.db.models.deletion.CASCADE, related_name='ag_test_suite_results', to='core.Submission')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.RenameField(
            model_name='project',
            old_name='ultimate_submission_selection_method',
            new_name='ultimate_submission_policy'
        ),
