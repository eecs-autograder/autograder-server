# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-01-04 18:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('autogradertestcasebase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.AutograderTestCaseBase')),
                ('interpreter', autograder.utilities.fields.ShortStringField(choices=[('python', 'python'), ('python3', 'python3')], max_length=255, strip=True)),
                ...
                ('entry_point_filename', autograder.utilities.fields.ShortStringField(max_length=255, strip=True)),
            ],
            options={
                'abstract': False,
            },
