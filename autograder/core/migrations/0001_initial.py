    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ultimate_submission_policy', autograder.core.fields.ShortStringField(blank=True, choices=[('most_recent', 'most_recent'), ('best_basic_score', 'best_basic_score')], default='most_recent', help_text='The "ultimate" submission for a group is the one\n            that will be used for final grading. This field specifies\n            how the ultimate submission should be determined.', max_length=255, strip=False)),
