...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ag_test_name_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
                ('return_code_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
                ('stdout_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
                ('stderr_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
                ('compilation_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
                ('valgrind_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
                ('points_fdbk', autograder.utilities.fields.StringChoiceField(choices=[], max_length=255, strip=False)),
            ],
            options={
                'abstract': False,
            },
