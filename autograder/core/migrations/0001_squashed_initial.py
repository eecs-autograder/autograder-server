# Generated by Django 2.0.1 on 2018-04-26 02:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Manually moved this CreateModel for InstructorFile to run BEFORE
        # creating AGCommand. Then, we can add the field stdin_instructor_file
        # right after creating AGCommand. That way, we don't get an error when
        # trying to create models that use AGCommand as a related object and
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_obj', models.FileField(max_length=510,
                                              upload_to=autograder.core.models.project.instructor_file._get_project_file_upload_to_path,
                                              validators=[
                                                  autograder.core.models.project.instructor_file._validate_filename])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stdin_source', autograder.core.fields.EnumField(default=autograder.core.models.ag_command.ag_command_base.StdinSource('none'), enum_type=autograder.core.models.ag_command.ag_command_base.StdinSource, help_text='Specifies what kind of source stdin will be redirected from.')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=None,
                                    ...
                                    related_name='+', to='core.InstructorFile'),
        ),
        migrations.CreateModel(
