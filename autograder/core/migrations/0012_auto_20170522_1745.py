# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-05-22 17:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_stderr_project_file', models.ForeignKey(blank=True, default=None, help_text="An UploadedFile whose contents should be compared against this command's\n                     stderr. This value is used (and may not be null) when expected_stderr_source\n                     is ExpectedOutputSource.project_file and is ignored otherwise.", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.UploadedFile')),
                ('expected_stdout_project_file', models.ForeignKey(blank=True, default=None, help_text="An UploadedFile whose contents should be compared against this command's\n                     stdout. This value is used (and may not be null) when expected_stdout_source\n                     is ExpectedOutputSource.project_file and is ignored otherwise.", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.UploadedFile')),
            ],
            bases=(autograder.core.models.ag_model_base._AutograderModelMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setup_suite_cmds', autograder.core.fields.StringArrayField(allow_empty_strings=False, blank=True, default=list, help_text="A list of commands to be run before this suite's tests are run.\n                     These commands are only run once at the beginning of the suite.\n                     These commands will be run after the student and project files\n                     have been added to the sandbox.", max_string_length=255, size=None, string_validators=[], strip_strings=False)),
                ('teardown_suite_cmds', autograder.core.fields.StringArrayField(allow_empty_strings=False, blank=True, default=list, help_text="A list of commands to be run after this suite's tests are run.\n                     These commands are only run once at the end of the suite.", max_string_length=255, size=None, string_validators=[], strip_strings=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_setup_and_teardown_commands', models.BooleanField(default=True, help_text="Whether to show results from a suite's setup and teardown commands.")),
            ],
            options={
                'abstract': False,
            },
