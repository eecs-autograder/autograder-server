# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-10-10 15:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criterion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='handgrading.Criterion')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('first_line', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('last_line', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='handgrading.HandgradingResult'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='comment',
            name='location',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='handgrading.Location'),
        ),
        migrations.AddField(
